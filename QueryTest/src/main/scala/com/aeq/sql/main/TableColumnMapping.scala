...
class TableColumnMapping {
  def getTableAndColumn(allColumns: Set[String], allTables: Set[String]): scala.collection.mutable.Map[String, List[String]] = {
  ...
  def getTableAndColumnMapping(allcolumns: Set[String], allTables: Set[String], map: Map[String, String]) {
    if(allcolumns.equals((null))|allTables.equals(null)|map.equals(null)) throw new NullPointerException("can't be null")
