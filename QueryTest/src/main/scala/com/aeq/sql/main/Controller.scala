...
object Controller extends App{
 ...
 //val sqlQuery="SELECT Employee.Name, TrainingTaken.TrainingTitle, TrainingTaken.TrainingDate FROM Employee INNER JOIN TrainingTaken ON Employee.EmployeeID = TrainingTaken.EmployeeID"
  ...
  //println("TWA:"+tablesWithAlaise.toSet)
